      ...
      <div class="row">
              ...
              <a href="index.php?page=produk&kat=" class="kategori-link">
                <div class="panel kategori-produk">
                    <div class="panel-body">
                        <img src="assets/img/kat/indoor.png" alt="" class="kat-img">
                    </div>
                </div>
              </a>
          </div>
          <div class="col-lg-4">
              <a href="index.php?page=produk&kat=" class="kategori-link">
                <div class="panel kategori-produk">
                    <div class="panel-body">
                        <img src="assets/img/kat/outdoor.png" alt="" class="kat-img">
                    </div>
                </div>
              </a>
          </div>
          <div class="col-lg-4">
              <a href="index.php?page=produk&kat=" class="kategori-link">
                <div class="panel kategori-produk">
                    <div class="panel-body">
                        <img src="assets/img/kat/display.png" alt="" class="kat-img">
                    </div>
                </div>
              </a>
          </div>
          <div class="col-lg-4">
              <a href="index.php?page=produk&kat=" class="kategori-link">
                <div class="panel kategori-produk">
                    <div class="panel-body">
                        <img src="assets/img/kat/digital.png" alt="" class="kat-img">
                    </div>
                </div>
              </a>
          </div>
          <div class="col-lg-4">
              <a href="index.php?page=produk&kat=" class="kategori-link">
                <div class="panel kategori-produk">
                    <div class="panel-body">
                        <img src="assets/img/kat/t-shirt.png" alt="" class="kat-img">
                    </div>
                </div>
              </a>
          </div>
